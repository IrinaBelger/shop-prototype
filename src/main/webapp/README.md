...
[`src/index.js`](index.js) with a call to `serviceWorkerRegistration.unregister()`.
...
[`public/manifest.json`](../../../front/public/manifest.json), that you can customize with
details specific to your web application.

When a user adds a web app to their homescreen using Chrome or Firefox on
Android, the metadata in [`manifest.json`](../../../front/public/manifest.json) determines what
